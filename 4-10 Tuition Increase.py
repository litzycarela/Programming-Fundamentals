...
for count in range(1, 6):
    print('The tuition cost for spring semester', count, 'is', format(CTUITION, '<4'))
    print()
    tuition = round(CTUITION * TRATE, ROUND)
# This is the output statement
    print('The tuition cost for fall semester', count, 'is', format(CTUITION, ">8"))
